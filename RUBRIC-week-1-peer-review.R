...
# Type your name here: Alberto Traverso
...
my_data<-data.frame("Animals" = c("Dog", "Cat", "Fish", "Fish", "Lizard"),"Foods"=c("Bread", "Orange", "Chocolate", "Carrots", "Milk"))
