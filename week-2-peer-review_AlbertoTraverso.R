...
#### Write your code below:
dat1$CC18_308a<-recode(dat1$CC18_308a,`1`=1,`2`=1,`3`=0,`4`=0)
dat1 <- rename(dat1,trump_approve_disapprove=CC18_308a)
dat1  
# Problem 3
