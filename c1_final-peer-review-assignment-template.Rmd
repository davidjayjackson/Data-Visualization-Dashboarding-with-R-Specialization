...
# dat <- dat %>% mutate(tax_scale = if_else(CC18_325d ==1 & CC18_325a ==1,2,0))
# dat <- dat %>% mutate(tax_scale = if_else(CC18_325d ==1 & CC18_325a ==0,1,0))
# dat <- dat %>% mutate(tax_scale = if_else(CC18_325d ==0 & CC18_325a ==0,0,0))
 

dat %>% mutate(tax_scale = 
                       case_when(CC18_325d ==1 & CC18_325a ==1   ~ 2, 
                                 CC18_325d ==1 & CC18_325a ==0 ~ 1, 
                                 CC18_325d ==0 & CC18_325a ==0 ~ 0))
